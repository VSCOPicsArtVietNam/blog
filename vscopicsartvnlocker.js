...
/*!
 * Localization
 * Tiếng Việt bởi VSCO PicsArt Việt Nam, http://www.vscopicsartvn.com
...
(function ($) {
    ...
    */
	...
	$.pandalocker.lang.vn = {
        ...
        // the Screen "Vui lòng xác nhận Email của bạn"
		confirm_screen_title:			"Vui lòng xác nhận Email của bạn",
		confirm_screen_instructiont:	"Chúng tôi đã gửi một email xác nhận đến {email}. Vui lòng bấm vào liên kết xác nhận trong email để xem nội dung.",
		confirm_screen_note1:			"Nội dung sẽ được mở tự động trong vòng 10 giây sau khi xác nhận.",
		confirm_screen_note2:			"Lưu ý việc chuyển email có thể mất vài phút.",
		
		confirm_screen_cancel:			"(Huỷ bỏ)",
		confirm_screen_open:			"Mở hộp thư đến của tôi trên {service}",
		
        // the Screen "One Step To Complete"
	
		onestep_screen_title:			"Một bước nữa để hoàn thành",
		onestep_screen_instructiont:	"Hãy nhập email của bạn dưới đây để tiếp tục.",
		onestep_screen_button:			"OK, Xong",
        
        // the sign-in buttons
		
		signin_long:					"Đăng nhập qua {name}",
		signin_short:					"qua {name}",
		signin_facebook_name:			"Facebook",
		signin_twitter_name:			"Twitter",
		signin_google_name:				"Google",
		signin_linkedin_name:			"LinkedIn",
		...
		misc_data_processing:			"Đang xử lý dữ liệu, vui lòng đợi ...",
		misc_or_enter_email:			"Hoặc nhập email của bạn theo cách thủ công để đăng nhập",
		
		misc_enter_your_name:			"nhập tên của bạn",
		misc_enter_your_email:			"nhập địa chỉ email của bạn",
		
		misc_your_agree_with:			"Bằng cách nhấp vào nút (s), bạn đồng ý với {links}",
		misc_terms_of_use:				"Điều khoản sử dụng",
		misc_privacy_policy:			"Chính sách riêng tư",
		
		misc_or_wait:					"hay chờ đợi {timer} giây.",
		misc_close:						"Đóng",
		misc_or:						"Hoặc",
        
        // errors & notices
        
		errors_empty_email:				"Hãy điền địa chỉ email của bạn.",
		errors_inorrect_email:			"Bạn đã nhập một địa chỉ email không chính xác. Xin vui lòng kiểm tra lại.",
		errors_empty_name:				"Vui lòng nhập tên của bạn.",
		errors_empty_field:				"Vui lòng điền vào trường này.",
		errors_invalid_value:			"Giá trị không hợp lệ. Vui lòng kiểm tra giá trị bạn đã nhập.",
		errors_invalid_date:			"Vui lòng nhập ngày hợp lệ.",
		errors_invalid_month:			"Vui lòng nhập số tháng hợp lệ (sô từ 01 đến 12).",
		
		errors_subscription_canceled:	"Bạn đã hủy đăng ký của mình.",
		errors_not_signed_in:			"Xin lỗi, nhưng bạn chưa đăng nhập. Vui lòng thử lại.",
		res_errors_not_granted:			"Xin lỗi, nhưng bạn chưa có đủ các quyền cần thiết ({permissions}). Vui lòng thử lại.",
		...
		error:							"Lỗi",
		noSpam:							"Địa chỉ email của bạn an toàn 100% từ spam!",
        
        errors: {
		
			ajaxError:						'Lỗi ajax không mong đợi. Vui lòng kiểm tra bảng điều khiển đăng nhập để biết thêm chi tiết.',
			unableToLoadSDK:				'Không thể tải tập lệnh SDK cho "{0}" do lỗi "{1}". Hãy chắc chắn rằng không có gì chặn các mã xã hội trong trình duyệt của bạn. Một số công cụ mở rộng như (Avast, PrivDog, AdBlock vv) hoặc sử dụng các tab riêng tư trong FireFox có thể gây ra vấn đề này. Tắt chúng và thử lại.',
			unableToCreateControl:			'Không thể tạo ({0}). Hãy chắc chắn rằng không có gì chặn các mã xã hội trong trình duyệt của bạn. Một số công cụ mở rộng như (Avast, PrivDog, AdBlock vv) có thể gây ra vấn đề này. Tắt chúng và thử lại.',
			invlidFacebookAppId:			'ID App không hợp lệ hoặc URL không được chấp nhận bởi cấu hình ứng dụng: Một hoặc nhiều URL đã cung cấp không được phép bởi các thiết lập. Nó phải khớp với URL của trang web hoặc Canvas URL, hoặc tên miền phải là tên miền phụ của một trong các tên miền của App.',
			emptyFBAppIdError:				'Hãy cài App ID Facebook của bạn.',
			emptyTwitterFollowUrlError:		'Vui lòng đặt một URL của tiểu sử trên Twitter của bạn.',
			tweetNotFound:					'Hãy đảm bảo rằng bạn đã đăng tweet. Thật không may chúng tôi đã không quản lý để tìm tweet trong tài khoản của bạn.',
			followingNotFound:				'Hãy đảm bảo rằng bạn đã theo dõi chúng tôi. Thật không may chúng tôi đã không tìm thấy bạn trong danh sách những người theo dõi.',
			unsupportedTwitterTweetLayout:	'Nút Twitter Tweet không hỗ trợ cách bố trí theo chiều dọc. Vui lòng xóa nút Tweet hoặc chọn một chủ đề khác.',
			unsupportedTwitterFollowLayout:	'Nút Theo dõi Twitter không hỗ trợ cách bố trí theo chiều dọc. Vui lòng xóa nút Theo dõi hoặc chọn một chủ đề khác.',
			emptyYoutubeChannelId:			'Vui lòng cài ID Kênh Youtube của bạn.',
			emptyGoogleClientId:			'Vui lòng cài Google Client ID.',
			unsupportedYoutubeSubscribeLayout: 'Nút đăng ký Youtube không hỗ trợ cách bố trí theo chiều dọc. Vui lòng xóa nút Đăng ký hoặc chọn một chủ đề khác.'
        ...
        scopes: {
            ...
            signinLocker: {
				...
				defaultHeader:		"Đăng nhập để mở khóa nội dung này",
				defaultMessage:		"Vui lòng đăng nhập. Chỉ cần bấm vào một trong các nút bên dưới để có quyền truy cập nhanh.",
				
				btnSubscribe:		"đăng nhập để mở khóa",
            ...
            emailLocker: {
				...
				defaultHeader:		"Nội dung này chỉ dành cho Người đăng ký",
				defaultMessage:		"Vui lòng đăng ký để mở khóa nội dung này. Chỉ cần nhập email của bạn.",
				
				btnSubscribe:		"Đăng ký để mở khóa",
            ...
            socialLocker: {
				...
				defaultHeader:		"Nội dung này đã bị ẩn",
				defaultMessage:		"Vui lòng hỗ trợ chúng tôi, sử dụng một trong các nút bên dưới để xem nội dung ẩn."
        ...
        connectButtons: {
            ...
            defaultMessage: "đăng ký thông qua hồ sơ xã hội của bạn bằng một cú nhấp chuột",

            facebook: {},
            
            google: {
			
				clientIdMissed: "ID Google Client chưa được cài. Bạn cần tạo một ID khách hàng trước khi sử dụng nút.",
				unexpectedError: "Không thể đăng nhập. Đã xảy ra lỗi không mong muốn: {0}"
				
            },
            
            twitter: {
			
                proxyEmpty: "URL proxy trống. Proxy được sử dụng để gọi Twitter API."
				
            },
            
            linkedin: {
			
                clientIdMissed: "LinkedIn Client ID hoặc Khách hàng bí mật không được thiết lập. Bạn cần thiết lập các cài đặt này trước khi sử dụng nút."
				
            },
			
			defaultSeparator: "hoặc",
			
			errorYouTubeChannelMissed: "Vui lòng đặt ID của kênh Youtube của bạn để đăng ký.",
			errorLinkedInCompanyNotFound: "LinkedIn company '{0}' không tìm thấy.",
			errorLinkedInCompanyMissed: "Vui lòng chỉ định ID công ty LinkedIn hoặc tên để theo dõi.",
			errorTwitterUserMissed: "Vui lòng chỉ định tên người dùng Twitter để theo dõi.",
			errorTwitterMessageMissed: "Vui lòng chỉ định tin nhắn để tweet."
        ...
        subscription: {
            ...
            defaultText: 'Không thể đăng nhập qua mạng xã hội? Nhập email của bạn theo cách thủ công.',
			defaultButtonText: 'Hoàn thành, đăng nhập để mở khóa'
        ...
        socialButtons: {
            ...
            // default labels for the buttons covers
            facebookLike:       'Thích',
            facebookShare:      'Chia sẻ',
            twitterTweet:       'Tweet',  
            twitterFollow:      'Theo dõi',  
            googlePlus:         'G +1', 
            googleShare:        'Chia sẻ',
            youtubeSubscribe:   'Đăng ký',
            linkedinShare:      'Chia sẻ'
			
        }
	
	};
    
    $.pandalocker.lang = $.pandalocker.lang.vn;  
